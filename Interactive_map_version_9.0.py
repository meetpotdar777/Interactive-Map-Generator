...
weatherControl.onAdd = function (map) {{
    ...
    div.innerHTML = `
        ...
        <p style="font-size: 0.8em; margin-bottom: 5px; color: #666;">Click on map for local weather, or:</p>
        <button id="get-center-weather-btn" style="background-color: #28a745; color: white; border: none; padding: 8px 12px; border-radius: 4px; cursor: pointer; width: 100%; margin-bottom: 10px;">
            <i class="fa fa-map-marker-alt"></i> Get Weather for Map Center
        </button>
        <div id="weather-result" style="font-size: 0.9em; min-height: 50px; border: 1px solid #eee; padding: 5px; border-radius: 3px; background-color: #f9f9f9; display: flex; align-items: center; justify-content: center; text-align: center;">
            Click a location on the map or use the button above.
        </div>
...
// Add event listener for the new button AFTER it's added to the map
m.on('load', function() {{
