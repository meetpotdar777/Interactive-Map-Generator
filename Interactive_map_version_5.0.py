...
random_points_group = folium.FeatureGroup(name='Random Points').add_to(m) # New group for random points
...
# --- 13. Add Random Points with Dynamic Popups/Tooltips ---
print("Adding random points with dynamic popups...")
for i in range(20):
    ...
    icon_name = "star" if value > 80 else "circle"
...
# --- 14. Add Custom JavaScript Interaction (includes reverse geocoding on click) ---
...
# --- 15. Add core plugins for enhanced interactivity (re-ordered for logical flow and placement) ---
...
# --- 16. Add the Layer Control to the map ---
...
# --- 17. Save the map to an HTML file ---
